...
class TestCompaction(unittest.TestCase):
    def _happy_path_enging_builder(self):
        ...
        beg.add_file("test_policy/data/f1.html", tree_crawl.trim_html(html))
        beg.add_file(
            "test_policy/data/f2.html", "..."
    ...
    def test_fat_happy_path(self):
        ...
        self.assertDictEqual(
            engine.file_system.files,
            {
                Filename("test_policy/data/f1.html"): (
    ...
    def test_erase_entire_old_before_any_new(self):
        ...
        beg.add_file("test_policy/data/f1.html", tree_crawl.trim_html(html))
        # Add big file.
        beg.add_file("test_policy/data/f0.html", "".join(["." for _ in range(1000)]))
    ...
    def test_multiple_policies(self):
        ...
        # TODO: Consistent typing in tests...
        beg.add_file("test_policy_1/data/f1.html", tree_crawl.trim_html(html))
        beg.add_file("test_policy_2/data/f1.html", tree_crawl.trim_html(html))
